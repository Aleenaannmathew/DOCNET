        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Appointments</a></li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Cardiology</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Neurology</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Pediatrics</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Dermatology</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Ophthalmology</a></li>
              <li><a href="#" className="text-gray-600 hover:text-blue-600 transition-colors">Dentistry</a></li>
            </ul>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-600">support@docnet.com</p>
              </div>
            </div>
          </div>
        </div>
