...
const DoctorChangePassword = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await doctorAxios.post('/change-password/', {
      ...
      if (response.data.success) {
        ...
        // Logout doctor after successful password change
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* Main Content */}
      <div className="flex-1 flex flex-col py-8 sm:px-6 lg:px-8">
                ...
                <div className="mt-1 relative rounded-md shadow-sm">
                  ...
                  <input
                    ...
                    className={`block w-full pl-10 pr-12 py-2 border ${
                      errors.oldPassword ? 'border-red-300 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 focus:ring-blue-500 focus:border-blue-500'
