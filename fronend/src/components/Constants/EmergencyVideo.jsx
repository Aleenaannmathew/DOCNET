  ...
  useEffect(() => {
    ...
    const start = async () => {
      try {
        ...
        const wsUrl = `ws://127.0.0.1:8000/ws/emergency/emergency_${emergencyId}/?token=${encodeURIComponent(token)}`;
    ...
    <div className="fixed inset-0 bg-gray-900 text-white z-50 flex flex-col">
      <div className="bg-gray-800 p-2 text-center text-sm">
        ...
        <div className="text-xs text-gray-400 mt-1">
          Room: {emergencyId} | User: {currentUser} | ICE: {isConnected ? 'Connected' : 'Not Connected'} |
